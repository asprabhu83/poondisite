...
{
    _deprecated_function('add_action','1.0.0','hooks()->add_action($tag, $function_to_add, $priority = 10, $accepted_args = 1)');
...
{
    _deprecated_function('do_action','1.0.0','hooks()->do_action($tag, $arg = \'\')');
...
{
    _deprecated_function('remove_action','1.0.0','hooks()->remove_action($tag, $function_to_remove, $priority = 10)');
...
{
    _deprecated_function('has_action','1.0.0','hooks()->has_action($tag, $function_to_check = false)');
