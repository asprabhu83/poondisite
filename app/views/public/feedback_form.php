...
if (isset($_POST['roll_no'])) { // Fetching variables of the form which travels in URL
    ...
    if (!empty($regno)) {
        //Insert Query of SQL
        $sql = "INSERT INTO `feedbackresponse`(`regno`, `q1`, `q2`, `q3`, `q4`, `q5`, `q6`, `q7`, `q8`, `q9`, `q10`, `aos`) VALUES ('$regno','$q1','$q2','$q3','$q4','$q5','$q6','$q7','$q8','$q9','$q10','$aos')";
...
<head>
    <meta charset="utf-8">
    <title>Curriculum Student Feedback</title>
