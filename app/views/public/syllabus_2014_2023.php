...
<main class="syllabus_2017">
    <div class="container">
        <div class="heading">Syllabus 2014, 2017, 2020 & 2023</div>
        <div class="table_contents" style="overflow-x:auto;">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>History</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/ba_history_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.A_History_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.A_History_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Economics</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/ba_economics_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.A_Economis_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.A_Economis_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Tamil</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/ba_tamil_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.A_Tamil_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.A_Tamil_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Indian Culture</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/ba_indianculture_syllabus') ?></td>
                        ...
                        <td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.A_IC_Syllabus_2023') ?></td>
                        <td class="pdf_items">-</td>
                    </tr>
                    <tr>
                        <td>B.Lit. Tamil</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/ba_literature_syllabus') ?></td>
                        <td class="pdf_items">-</td>
                    ...
                    <tr>
                        <td>English</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/ba_english_syllabus') ?></td>
                    ...
                    <tr>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Com_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Com_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>B. Com. C.A.</td>
						...
						<td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Com_CA_Syllabus_2023') ?></td>
						<td class="pdf_items">-</td>
                    </tr>
                    <tr>
                        <td>B. Com. B. M.</td>
						...
						<td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Com_BM_Syllabus_2023') ?></td>
						<td class="pdf_items">-</td>
                    </tr>
                    <tr>
                        <td>Mathematics</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_mathematics_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Sc_Mathematics_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Sc_Mathematics_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Physics</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_physics_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Sc_Physics_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Sc_Physics_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Chemistry</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_chemistry_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Sc_Chemistry_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Sc_Chemistry_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Botany</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_botany_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Sc_BOTANY_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Sc_Botany_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Microbiology</td>
                        <td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2014_updated/PG_SYLLABUS/msc_microbiology_syllabus') ?></td>
                        <td class="pdf_items">-</td>
                        ...
                        <td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Sc_Microbiology_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Zoology</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_zoology_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Sc_ZOOLOGY_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Sc_ZOOLOGY_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Biotechnology</td>
                        <td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2014_updated/PG_SYLLABUS/msc_biotechnology_syllabus') ?></td>
                        <td class="pdf_items">-</td>
                        ...
                        <td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Sc_BIOTECHNOLOGY_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Computer Science</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_computerscience_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Sc_CS_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/M.Sc_COMPUTER_SCIENCE_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Computer Applications</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bca_syllabus') ?></td>
                        ...
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.C.A_Syllabus_2023') ?></td>
						<td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/MCA_Syllabus_2023') ?></td>
                    </tr>
                    <tr>
                        <td>Information Technology</td>
                        <td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2014_updated/PG_SYLLABUS/msc_informationtechnology_syllabus') ?></td>
                        <td class="pdf_items">-</td>
                        ...
                        <td class="pdf_items">-</td>
                        <!-- <td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/msc_informationtechnology_syllabus') ?></td> -->
                        <td class="pdf_items">-</td>
                    </tr>
                    <tr>
                        <td>Physical Education, Health Education and Sports</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_physicaleducation_syllabus') ?></td>
						<td class="pdf_items">-</td>
						...
						<td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Sc_Phy_Edu-Syllabus_2023') ?></td>
						<td class="pdf_items">-</td>
                    </tr>
                    <tr>
                        <td>Business Administration	</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bba_syllabus') ?></td>
						<td class="pdf_items">-</td>
						...
						<td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/BBA_Syllabus_2023') ?></td>
						<!-- <td class="pdf_items">-</td> -->
                        <td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/MBA_Syllabus_2023') ?></td>
						<!-- <td class="pdf_items">-</td> -->
                    </tr>
                    <tr>
                        <td>Business Administration(LS)	</td>
                        <!-- <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bba_syllabus') ?></td> -->
						<td class="pdf_items">-</td>
                        <td class="pdf_items">-</td>
                        <!-- <td><?php syllabus_link('syllabus_2017_updated/UG_SYLLABUS/bba_syllabus') ?></td> -->
                        ...
                        <td class="pdf_items">-</td>
                        <td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/MBA_LS_Syllabus_2023') ?></td>
						
                    </tr>
                    <tr>
                        <td>Statistics</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_statistics_syllabus') ?></td>
                        <td class="pdf_items">-</td>
                        ...
                        <td class="pdf_items">-</td>
                        <!-- <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/bsc_statistics_syllabus') ?></td> -->
                        <td class="pdf_items">-</td>
                    </tr>
                    <tr>
                        <td>Geography</td>
                        <td><?php syllabus_link('syllabus_2014_updated/UG_SYLLABUS/bsc_geography_syllabus') ?></td>
                        <td class="pdf_items">-</td>
                        ...
                        <td class="pdf_items">-</td>
                        <td><?php syllabus_link('syllabus_2023_updated/UG_SYLLABUS/B.Sc_GEOGRAPHY_Syllabus_2023') ?></td>
                        <td class="pdf_items">-</td>
                    </tr>
                    <tr>
                        <td>M.L.I.S</td>
                        <td class="pdf_items">-</td>
						<td><?php syllabus_link('syllabus_2014_updated/PG_SYLLABUS/mlis_syllabus') ?></td>
                        <td class="pdf_items">-</td>
                        ...
                        <td class="pdf_items">-</td>
						<!-- <td><?php syllabus_link('syllabus_2023_updated/PG_SYLLABUS/mlis_syllabus') ?></td> -->
                    </tr>
                    <!-- <tr>
