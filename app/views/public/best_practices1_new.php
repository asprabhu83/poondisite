...
<div class="section-height-800 breadcrumb-statutory-committees context-dark text-center">
	<div class="shell section-bottom-30">
		<div class="veil reveal-md-block">
			<h1 class="text-bold" style="color: cornsilk;">Best Practices</h1>
		</div>
		...
		<div class="range range-xs-center">
			<div class="cell-sm-12 cell-lg-12">
				<div class="offset-top-60 offset-md-top-90">
					<h2 class="text-bold">Best Practices</h2>
					<br /><br />
						...
						<div>
							<div data-type="horizontal" class="responsive-tabs responsive-tabs-classic horizontal">
								<ul class="resp-tabs-list tabs-1 text-center tabs-group-default" data-group="tabs-group-default">
									<li class="tab"><strong>Best Practice - I</strong></li>
									<li class="tab"><strong>Best Practice - II</strong></li>
								...
								<div data-group="tabs-group-default" class="resp-tabs-container text-sm-left tabs-group-default">
									...
									<div>
										<div class="inset-lg-left-30">
											<h5>Best Practices - I</h5>
											<br />
											<table border="1px">
												<tbody></tbody>
												<tbody>
													<tr>
														<td><strong>1. Title of the practicePATRON</strong><br />Thiru. T. Krishnasamy Vandayar, B.Tech.
