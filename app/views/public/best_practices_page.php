			...
			<ul class="list-inline list-inline-with-arrows p">
				...
				<li>Best Practices</li>
                                                ...
                                                <div>
													<br><br>
													<h2 class="text-bold">
                                                        <a href="<?php echo base_url('best_practices1') ?>"><span class="text-middle">Best Practices-I</span></a>
                                                    </h2>    
                                                    <br><br>
													<h2 class="text-bold">
                                                         <a href="<?php echo base_url('best_practices2') ?>"><span class="text-middle">Best Practices-II</span></a>
