...
<style type="text/css">
    ...
    body {background-color: powderblue;}
        ...
        h2   {text-align: left;color: brown;}
...
<div class="section-height-800 breadcrumb-infrastructure-facilities context-dark text-center">
	<div class="shell section-bottom-30">
		<div class="veil reveal-md-block">
			<h1 class="text-bold" style="color: cornsilk;">About IQAC</h1>
		</div>
...
<section class="section-90 section-md-top-120 section-md-bottom-111">
	<div class="shell-fluid">
		...
		<h2 class="text-bold a">About IQAC</h2>
		<!-- <div class="range range-xs-center range-md-left text-md-left"> -->
			<!-- <div class="cell-xs-4 cell-sm-4 cell-md-4 cell-xl-12 cell-xl-preffix-1"><img alt="" class="img-responsive" height="150" src="<?php echo base_url('assets/images/clg.jpg')?>" width="1500" /></div> -->
            <!-- <div><img alt=""  height="250" src="<?php echo base_url('assets/images/clg.jpg')?>" width="500" /></div> -->
         <br>
            <!-- <div class="cell-xs-4 cell-sm-4 cell-md-4 cell-xl-6 cell-xl-preffix-1"><img alt="" class="img-responsive" height="250" src="<?php echo base_url('assets/images/bank.jpg')?>" width="250" /></div> -->
			<!-- <div class="cell-xs-4 cell-sm-4 cell-md-4 cell-xl-12 cell-xl-preffix-1"> -->
				<!-- <h3 class="text-bold">Special Features</h3> -->
     <div class="a"> 
				...
				<h2 class="text-bold">Objective</h2>
				<br/>
				<ul id="list">
				...
				<h2 class="text-bold">Strategies</h2>
				...
				<h2 class="text-bold">Functions</h2>
				...
				<h2 class="text-bold">Benefits</h2>
