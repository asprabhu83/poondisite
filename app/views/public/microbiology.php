		...
		<div class="shell-fluid">
			<div class="range range-75 text-left">
				...
				<div class="cell-xs-8 cell-lg-8">
					<h2 class="text-bold text-center">PG &amp; Research department of Microbiology</h2>
					...
					<!--	<h4 align="" class="text-bold" id="q-1" data-type="anchor">PROGRAMMES</h4>
						...
						<table border="1px" cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
							...
							<tbody>
								...
								<tr>
									<th><a href="<?php echo base_url('public/pdf/Departments/botany/12.%20Dr.%20C.Karpagasundari.pdf') ?>" target="_blank" rel="noopener">Dr. C. Karpagasundari</a></th>
									<td style="text-align: center;">Assistant Professor</td>
								</tr>
								<tr>
									<th><a href="<?php echo base_url('public/pdf/Departments/botany/13.%20Dr.M.MAHADEVI.pdf') ?>" target="_blank" rel="noopener">Dr. M. Mahadevi</a></th>
									<td style="text-align: center;">Assistant Professor</td>
								</tr>
								<tr>
