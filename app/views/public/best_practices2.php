		...
		<div class="shell-fluid">
			<div class="range range-75 text-left">
				<div class="cell-xs-8 cell-md-12 cell-lg-12">
                    ...
                    <p align="justify"> Under the auspices of Tamil Nadu State Council for Science and Technology, the college has been organizing YSSP utilizing the academic resources of the institution  since 1995. The key objective of the programme is to enrich the impressionable mind with the science knowledge, analytical and research aptitude. The institution facilitates school students to take part in an extensive training programmefor 15 daysduring summer vacation by inviting high-profile faculty members as resource persons. </p>
                   
                    <h5 style="color:blue;" class="text-left"><strong>Unnat Bharat Abiyan(UBA)</strong></h5>
                    <p align="justify"> As an inclusive knowledge unit, the college is privileged to participate in UBA, which best suits the institution’s academic inclusive ideology. Since the inception of the UBA,the institution caters to the rural societal needs with the resource capacity of the college.Engaging themselves in fieldwork,interaction and investigation, the dedicated faculty members and students enable the rural community gain access to knowledge resources of the college to fulfill their basic amenities. </p>
