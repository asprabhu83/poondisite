...
<div class="section-height-800 breadcrumb-founders context-dark text-center">
	<div class="shell section-bottom-30">
		<div class="veil reveal-md-block">
			<h1 class="text-bold" style="color: cornsilk;"><strong>Founders</strong></h1>
		</div>
...
<section class="section-90 section-md-top-120 section-md-bottom-111">
		...
		<div class="range range-xs-center range-md-left text-left">
			<div class="cell-xs-10 cell-sm-8 cell-md-3">
				<div class="thumbnail-team-1">
					...
					<div class="thumbnail-team-body">
						<h5 class="text-bold"align="center">Thiru.A. Veeriya Vandayar</h5>
						<h6 class="text-bold"align="center">Founder President</h6>
						<!-- <p><strong>Thiru.A. Veeriya Vandayar</strong></p> -->
					</div>
				</div>
			</div>
			<div class="cell-xs-10 cell-sm-8 cell-md-3 offset-top-60 offset-md-top-0">
				<div class="thumbnail-team-1">
					...
					<div class="thumbnail-team-body">
						<h5 class="text-bold"align="center">Thiru.A. KrishnaswamyVandayar</h5>
						<h6 class="text-bold"align="center">Founder Secretary</h6>
						<!-- <p><strong>Thiru.A. KrishnaswamyVandayar</strong></p> -->
					</div>
				</div>
			</div>
			 <div class="cell-xs-10 cell-sm-8 cell-md-3 offset-top-60 offset-md-top-0">
				<div class="thumbnail-team-1">
					...
					<div class="thumbnail-team-body">
						<h5 class="text-bold"align="center">Thiru.V.Appavoo Vandayar</h5>
						<h6 class="text-bold"align="center">Former President</h6>
						<!-- <p><strong>Thiru.V.Appavoo Vandayar</strong></p> -->
					</div>
				</div>
			</div>
			<div class="cell-xs-10 cell-sm-8 cell-md-3 offset-top-60 offset-md-top-0">
				<div class="thumbnail-team-1">
					...
					<div class="thumbnail-team-body">
						<h5 class="text-bold" align="center">Thiru.V. AppaswamyVandayar</h5>
	...
	<br /><br />
	<h4 align="center"><strong>Humble Salutations to Founding Fathers</strong></h4>
</section>
