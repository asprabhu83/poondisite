...
init_public_head();
?>
<div class="section-height-800 breadcrumb-non-statutory-committees context-dark text-center">
	<div class="shell section-bottom-30">
		<div class="veil reveal-md-block">
			<h1 class="text-bold" style="color: cornsilk;">Non-Statutory Committees</h1>
		</div>
	...
	<div class="shell">
		<div class="range range-xs-center">
			<div class="cell-sm-12 cell-lg-12">
				<div class="range range-md-center offset-top-30"></div>
				<div class="offset-top-60 offset-md-top-90">
					<h2 class="text-bold">Non-Statutory Committees</h2>
					<section class="section-90 section-md-120">
										...
										<div class="offset-top-60">
											...
											<div data-type="accordion" class="responsive-tabs responsive-tabs-custom">
												<ul class="resp-tabs-list tabs-group-default" data-group="tabs-group-default">
													<li class="tab">Admission</li>
													<li class="tab">Examination</li>
													<li class="tab">Student Academic Grievance Redressal</li>
													<li class="tab">Library</li>
													<li class="tab">Magazine</li>
													<li class="tab">Academic Calendar</li>
													<li class="tab">General Time Table</li>
												</ul>
													...
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																...
																<tr>
																	<td>Dr. V.Manimekalai</td>
																	<td></td>
																	<td>Botany</td>
																</tr>
																<tr>
																	<td>Prof. N.Loganathan</td>
																	<td></td>
																	<td>Economics</td>
																</tr>
																<tr>
																	<td>Dr. M.Gurumoorthy</td>
																	<td></td>
																	<td>Mathematics</td>
																</tr>
															</tbody>
													...
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																...
																<tr>
																	<td>Prof.P.Vanathi</td>
																	<td></td>
																	<td>Botany</td>
																</tr>
																<tr>
																	<td>Dr.R.Subashini</td>
																	<td></td>
																	<td>Commerce</td>
																</tr>
																<tr>
										...
										<div class="offset-top-60">
											...
											<div data-type="accordion" class="responsive-tabs responsive-tabs-custom">
												<ul class="resp-tabs-list tabs-group-default" data-group="tabs-group-default">
													...
													<li>Literary and Cultural Committee</li>
													<li>Training &amp; Placement Cell</li>
													<li>Career Guidance &amp; Counselling Cell</li>
													<li>Research Advisory Committee</li>
													<li>Student's non-Academic Discipline Committee</li>
													...
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																...
																<tr>
																	<td>Dr. S. Thennarasu</td>
																	<td></td>
																	<td>Economics</td>
																</tr>
																<tr>
																	<td>Dr. K. Nambirajan</td>
																	<td></td>
																	<td>Zoology</td>
																</tr>
																<tr>
																	<td>Dr. S. Vishnu Varthanaraj</td>
																	<td></td>
																	<td>Chemistry</td>
																</tr>
																<tr>
													...
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																...
																<tr>
																	<td>Dr. S. Prabakaran</td>
																	<td></td>
																	<td>History</td>
																</tr>
																<tr>
																	<td>Prof. P. Syamala</td>
																	<td></td>
																	<td>Mathematics</td>
																</tr>
																<tr>
								...
								<div class="cell-sm-10 cell-md-11 cell-lg-9 cell-xl-6">
									<div>
										<div class="offset-top-60">
											...
											<div data-type="accordion" class="responsive-tabs responsive-tabs-custom">
												<ul class="resp-tabs-list tabs-group-default" data-group="tabs-group-default">
													<li class="tab">Anti-Ragging Committee</li>
												...
												<div data-group="tabs-group-default" class="resp-tabs-container tabs-group-default">
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																...
																<tr>
																	<td>Dr. C. Thillaiyadi Valliammai</td>
																	<td></td>
																	<td>Chemistry</td>
																</tr>
																<tr>
													...
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																...
																<!-- <tr>
																	<td>Dr.R.Prakash Babu</td>
																	<td></td>
																	<td>Commerce</td>
																</tr>

																<tr>
																	<td>Dr.R.Palanivelu</td>
																	<td></td>
																	<td>Economics</td>
																</tr>
													...
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																...
																<tr>
																	<td>Dr. R. Prakashraj</td>
																	<td></td>
																	<td>Zoology</td>
																</tr>
																<tr>
																	<td>Dr. S. Rajarajeswari</td>
																	<td></td>
																	<td>Economics</td>
																</tr>
																<tr>
																	<td>Dr. T. Mahendran</td>
																	<td></td>
																	<td>English</td>
																</tr>
																<tr>
													...
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																<tr>
																	<td>Prof. P. Aravazhi</td>
																	<td></td>
																	<td>Tamil</td>
																</tr>
																<tr>
																	<td>Dr. K. Thirumurgan</td>
																	<td></td>
																	<td>Physics</td>
																</tr>
																<tr>
																	<td>Dr. R. Balakrishnan</td>
																	<td></td>
																	<td>Commerce</td>
																</tr>
																<tr>
																	<td>Dr. G.Gnanasankari</td>
																	<td></td>
																	<td>Tamil</td>
																</tr>
																<!-- <tr>
													...
													<div>
														<table cellpadding="3" cellspacing="5" height="100" style="width: 100%;" width="70">
															<tbody>
																...
																<tr>
																	<td>Dr. K. Jeyaseelan</td>
																	<td></td>
																	<td>Zoology</td>
																</tr>
																<tr>
																	<td>Dr. C. Rajashree</td>
																	<td></td>
																	<td>Physics</td>
																</tr>
																<tr>
																	<td>Dr. K. Tamilselvi</td>
																	<td></td>
																	<td>Tamil</td>
																</tr>
																<!-- <tr>
					...
					<div class="shell-fluid">
						<div class="range range-xs-center text-left">
							<div class="cell-sm-8 cell-md-8 cell-lg-9 cell-xl-6">
								<h2 class="text-bold text-center">Magazine Committee</h2>
								<div class="offset-top-80">
									<table border="1px">
										<tbody></tbody>
										<tbody>
											<tr>
												<td style="width: 50%;">Dr. V. Nandakumar</td>
												<td style="width: 50%;">Chemistry</td>
											</tr>
											<tr>
												<td style="width: 50%;">Dr. J. Umasamundeswari</td>
												<td style="width: 50%;">English</td>
											</tr>
											<tr>
												<td style="width: 50%;">Dr. S. Ganesan</td>
												<td style="width: 50%;">Zoology</td>
											</tr>
											<tr>
												<td style="width: 50%;">Dr. N. Kannadasan</td>
												<td style="width: 50%;">Tamil</td>
											</tr>
