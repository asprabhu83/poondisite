                                           ...
                                           <!-- <li class="active "><a href="<?php echo base_url('pdf/SSR_Report/SSR_REVISED_REPORT.pdf') ?>"><span>SSR</span></a> 
                                            ...
                                            <li class="active"><a href="#"><span>NIRF</span></a>
                                                <ul class="rd-navbar-dropdown">
                                                    ...
                                                    <li class="active "><a href="<?php echo base_url('public/pdf/NIRF/NIRF_2026.pdf') ?>"><span>NIRF 2026</span></a>
                                            ...
                                            <li class="active"><a herf="#"><span>SPCTE</span></a>
                                                <ul class="rd-navbar-dropdown">
                                                    ...
                                                    <li class="active "><a href="<?php echo base_url('public/pdf/EOA_SPCTE/EOA_Report_2024-27.PDF') ?>"><span>EOA 2024-2027</span></a> 
                                                    <li class="active "><a href="<?php echo base_url('public/pdf/EOA_SPCTE/EOA_Report_2024-25.PDF') ?>"><span>EOA 2024-2025</span></a> 
