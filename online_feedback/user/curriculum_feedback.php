...
$sql=mysqli_query($conn,"select * from feedback_curriculum where student_id='$user'");
...
if($r==true)
{
echo "<h2 style='color:red'>Already given feedback </h2>";
}
else
{
...
$query="insert into feedback_curriculum values('','$user','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10',now())";
...
<form method="post">
<fieldset>
<h1><center><u>Feedback of Students on Curriculum</u></center><br></h1>
<fieldset>
...
<th><button type="button" style="font-size:10pt;color:white;background-color:green;border:2px solid #336600;padding:3px">Excellent 4</button></th>
  <th><button type="button" style="font-size:10pt;color:white;background-color:Brown;border:2px solid #336600;padding:3px">Good 3</button></th>
  <th><button type="button" style="font-size:10pt;color:white;background-color:blue;border:2px solid #336600;padding:3px">Satisfactory 2</button></th>
  <th><button type="button" style="font-size:10pt;color:white;background-color:red;border:2px solid #336600;padding:3px">Poor 1</button></th>
</tr>
...
<tr>
<td><b>1:</b> Contents of the courses and relevance of the units</td>  
<td><input type="radio" name="quest1" value="4" required></td>
...
<td><input type="radio" name="quest2" value="4" required></td>
...
<td><input type="radio" name="quest3" value="4" required></td>
...
<td><input type="radio" name="quest4" value="4" required></td>
...
<td><input type="radio" name="quest5" value="4" required></td>
...
<td><input type="radio" name="quest6" value="4" required></td>
...
<td><input type="radio" name="quest7" value="4" required></td>
...
<td><input type="radio" name="quest8" value="4" required></td>
...
<td><input type="radio" name="quest9" value="4" required></td>
...
<td><input type="radio" name="quest10" value="4" required></td>
