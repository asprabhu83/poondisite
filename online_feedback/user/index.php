...
$sql=mysqli_query($conn,"select * from studentmaster where username='$user' ");
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background:#428bca">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <!-- <a class="navbar-brand" style="color:#FFFFFF" href="#">Hello <?php echo $studentmaster['username'];?></a>  -->
          <!-- <a class="navbar-brand" style="color:#FFFFFF" href="#">Hello </a>   -->
        </div>
