...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">AVVM SPC - Online feedback System</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li><a style="color:#FFFFFF" href="index.php?info=Curriculum_feedback"><i class="fa fa-sign-out fa-fw"></i>Curriculum_feedback</a></li> 
				
    <li class="dropdown">
    <!-- <a style="color:#FFFFFF" href="index.php?info=registration_stu"><i class="fa fa-sign-out fa-fw"></i>Student Registration</a></li>     -->
    <a style="color:#FFFFFF" href="#" class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-sign-in fa-fw"></i>Registration
    <span class="caret"></span></a>
        <ul class="dropdown-menu">          
          <li><a href="index.php?info=registration_stu">Student</a></li>
		  <li><a href="index.php?info=registration">Faculty</a></li>     
        </ul>
    </li> 
	...
	<li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="index.php?info=student_login">Student</a></li>
...
<?php 
					...
					if($info!="")
					{
                         ...
                         else if($info=="registration_sta")
						 {
						 	include('registration_sta.php');
						 }
                         else if($info=="registration_stu")
						 {
						 	include('registration_stu.php');
						 }
                         else if($info=="curriculum_feedback")
						 {
						 	include('curriculum_feedback.php');
						 }
					}
					else
					{
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/home.jpg');"></div>
            ...
            <div class="item">
			 ...
			 <div class="item">
                <div class="fill" style="background-image:url('images/hall.jpg');"></div>
                <div class="carousel-caption">
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				...
				Student Feedback system for AVVM Sri Pushpam College(Autonomous), Poondi, Thanjavur. 
Here we have developed the a faculty feedback system, which is generally used in our college to rate the faculty based on the performance...
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as student and another one as take
 -->	
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed By ....... 	<a href="https://sripushpamcollege.co.in/">AVVM SriPushpam College</a> </span>
	</div>
    <!-- jQuery -->
